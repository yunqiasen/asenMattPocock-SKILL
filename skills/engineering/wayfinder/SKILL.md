...
**Where the map, its child tickets, blocking, and frontier queries physically live is tracker-specific.** Read the issue tracker configuration from `docs/agents/issue-tracker.md`. If it is missing, tell the user to run the project initializer (`asen-skills init --project <path>`). Consult the tracker doc's "Wayfinding operations" section for how _this_ repo expresses them. If no tracker has been provided, default to the local-markdown tracker.
